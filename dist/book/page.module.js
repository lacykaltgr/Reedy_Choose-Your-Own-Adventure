...
PageModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'page', schema: page_model_1.PageSchema }])],
        controllers: [page_controller_1.PageController, book_controller_1.BookController],
