...
export default class SubscriptionsController {
    ...
    createReaderSubscription(session: Record<string, any>): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.Subscription>>;
    getReaderSubscription(session: Record<string, any>): Promise<import("stripe").Stripe.Subscription | import("@nestjs/common").NotFoundException>;
    createWriterSubscription(session: Record<string, any>): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.Subscription>>;
    getWriterSubscription(session: Record<string, any>): Promise<import("stripe").Stripe.Subscription | import("@nestjs/common").NotFoundException>;
}
