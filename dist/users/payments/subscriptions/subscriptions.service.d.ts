...
export default class SubscriptionsService {
    ...
    createMonthlySubscription(customerId: string): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.Subscription>>;
    getMonthlySubscription(customerId: string): Promise<import("stripe").Stripe.Subscription | NotFoundException>;
}
