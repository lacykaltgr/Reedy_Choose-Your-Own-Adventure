...
import { AddCreditCardDto, RemoveBankAccountDto, RemoveCreditCardDto, SetDefaultCreditCardDto, TransferDto } from './payments.validation';
export declare class PaymensController {
    private readonly usersService;
    private readonly authService;
    private readonly paymentsService;
    constructor(usersService: UserService, authService: AuthService, paymentsService: PaymentsService);
    addPaymentMethod(paymentMethod: AddCreditCardDto, session: Record<string, any>): Promise<{
        message: string;
    }>;
    listPaymentMethods(session: Record<string, any>): Promise<{
        paymentMethods: import("stripe").Stripe.Response<import("stripe").Stripe.ApiList<import("stripe").Stripe.PaymentMethod>>;
    }>;
    removePaymentMethod(session: Record<string, any>, paymentMethod: RemoveCreditCardDto): Promise<{
        message: string;
    }>;
    setDefaultCard(creditCard: SetDefaultCreditCardDto, session: Record<string, any>): Promise<void>;
    removeBankAccount(data: RemoveBankAccountDto, session: Record<string, any>): Promise<{
        message: string;
    }>;
    getBankAccount(data: RemoveBankAccountDto, session: Record<string, any>): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.CustomerSource>>;
    createTransfer(transferData: TransferDto): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.Transfer>>;
}
